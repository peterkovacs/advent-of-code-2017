...
let package = Package( name: "AdventOfCode2017",
                      targets: [
                        ...
                        Target( name: "Day16", dependencies: [ "Lib" ] ),
                        Target( name: "Day17", dependencies: [ "Lib" ] ),
                        Target( name: "Day18", dependencies: [ "Lib" ] ),
                        Target( name: "Day19", dependencies: [ "Lib" ] ),
                      ...
                      dependencies: [
                        .Package( url: "/Users/peter/Developer/FootlessParser", majorVersion: 1 ),
